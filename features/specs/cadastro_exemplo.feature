...
| 'joaosne11@1guts.com' | 'fem'  | 'Joao'     | 'Silva'   | '12345678' | '10' | 'March' | '1980' | 'no'       | 'ABCNow' | 'Rua x' | 'New York' | 'New York' | '55555' | '5559135'   | 'Casa'       |
| 'mariasn11@1guts.com' | 'fem'  | 'Maria'    | 'Souza'   | '12345678' | '15' | 'April' | '1993' | 'yes'      | 'Topten' | 'Rua X' | 'New York' | 'New York' | '12345' | '9998362'   | 'Trabalho'   |
